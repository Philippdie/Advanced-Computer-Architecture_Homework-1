...
We use processes only for the two parts that can delay driving: grabbing frames and running the neural network. The loop that steers the robot stays short: infrared check, possible buzzer trigger, \texttt{follow\_line}, optional LED update, and a 1 ms sleep. The queues carry frames and classification dictionaries; they never carry the \texttt{AlphaBot2} object.
